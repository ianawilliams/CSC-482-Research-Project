...
/*
###########################################################################
	Code written below here by Ian Williams
###########################################################################
*/
...
{	
	...
	//Itereates through the vertices and creates a table of edges
	while (vertex < n) {
		adj = 0;
		while (adj < 3) {
			num = 0;
	...
	/* 
		Assigns a factor based on amount 
		of number of criss crossing edges
	*/
	if (cross > 0) {
		if (cross < 3){
			crissCross = 0.5;
	...
	*/
	...
	/*
		Assigns a factor based on how much symmetry 
		is in the fullerene graph
	*/
	double sym;
	if (symmetry < 5) {
		sym = 1.0;
	...
	/*
		Multiplies the scores for each section by their percentage of the total score
	*/
...
/*
	Receives X,Y coordinates of 2 points and 
	finds the length of edge between them
*/
double length(double xa, double ya, double xb, double yb)
{
	double y = yb - ya;
...
/*
###########################################################################
	Code written Above here by Ian Williams
###########################################################################
*/
